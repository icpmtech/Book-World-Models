...
export default function MarketProPage(): ReactNode {
  return (
    <Layout
      title="Market Pro Digital"
      description="Market Pro Digital — advanced financial analytics platform for capital markets professionals."
    >
      {/* Page header */}
      <div
        style={{
      ...
      >
        ...
        <p>
          ...
          <Link to="/docs/intro">Financial World Models</Link>.
        </p>
        <p>
        ...
        <p>
          ...
          <Link href="https://market-pro.digital" target="_blank" rel="noopener noreferrer">
